...
import { User, Mail, Lock, Eye, EyeOff, ArrowRight, BadgeCheck } from 'lucide-react';
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="px-6 py-6">
                            ...
                            <div className="mb-4">
                                ...
                                <div className="relative">
                                    <BadgeCheck className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                                    <input
                                        type="text"
                                        name="studentId"
