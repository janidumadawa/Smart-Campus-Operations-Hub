// frontend/src/components/home/Aboutus.jsx
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/src/assets/sliit-image4.jpg"
          ...
          <div className="backdrop-blur-sm bg-[#0A2342]/40 rounded-2xl p-8 border border-[#F47C20]/20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              {values.map((value, index) => (
                <div
                  key={index}
                  className="flex gap-4 p-4 rounded-2xl bg-[#0A2342]/50 backdrop-blur-sm hover:bg-[#F47C20]/10 transition-all duration-300 border border-[#F47C20]/10 hover:border-[#F47C20]/30 group"
                >
